...
export const GameTagEditor: React.FC<GameTagEditorProps> = ({
  ...
  }, [currentGame, isOpen, setGamesList, setLoading, setSearchQuery, setSelectedGame])
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-border p-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-text-primary">Edit Game Tag</h2>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="p-4">
          {/* Clip info */}
          <p className="mb-4 text-sm text-text-muted">{clip.filename.replace('.mp4', '')}</p>
            ...
            {loading ? (
              ...
              <div className="divide-y divide-border">
                {filteredGames.map(game => (
                  ...
                  >
                    <Gamepad2
                      className={`h-4 w-4 ${selectedGame === game.name ? 'text-purple-400' : 'text-text-muted'}`}
                    />
